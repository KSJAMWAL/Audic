...
module.exports = {
    ...
    async execute(context) {
        try {
            ...
            if (!player) {
                return context.reply({ embeds: [errorEmbed('There is no active player in this server!')], ephemeral: true });
            }
            ...
            if (!current) {
                return context.reply({ embeds: [errorEmbed('There is no track currently playing!')], ephemeral: true });
            }
            ...
            return context.reply({ embeds: [errorEmbed('An error occurred while getting the now playing information!')], ephemeral: true });
        }
    }
};
